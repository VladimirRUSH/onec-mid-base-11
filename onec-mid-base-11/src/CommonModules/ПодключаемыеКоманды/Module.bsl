...
Процедура ПриСозданииНаСервере(Форма, ПараметрыРазмещения = Неопределено) Экспорт
	...
	// Ярушин Нач
	// Универсальное добавление в формы документов реквизита "Контактное лицо" и поля согласованная скидка и кнопки "Применить скидку"
	// в Заказ покупателя
	Ярушин_ДоработкаФорм.ДополнитьФорму(Форма);
	// Ярушин Кон
